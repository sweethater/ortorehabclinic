...
import { PatientTabs } from './Patient';
  ...
  return (
    <Fade>
      <div className="co-home-container co-content-container">
        <div className="co-home__content">
          <img className="co-container__logo-image" src={logo}/>
          <p className="co-container__paragraph co-center"><b>ORTO REHAB CLINIC</b> je dynamicky sa rozvíjajúcim moderným zdravotníckym pracoviskom, ktoré poskytuje svojim pacientom vysoko kvalifikovanú lekársku starostlivosť v špecializovanom odbore ortopédia, denzitometria, cievna chirurgia a fyzioterapia.</p>
          <p className="co-container__paragraph co-center"><b>ORTO REHAB CLINIC</b> disponuje najmodernejšou zdravotníckou technikou v segmente ambulantnej zdravotnej starostlivosti, a to nielen v oblasti ortopédie, denzitometrie, ale aj fyzioterapie.</p>
          <p className="co-container__paragraph co-center">Hlavnou devízou <b>ORTO REHAB CLINIC</b> je najmä efektívne objednávanie pacientov a minimálne čakacie doby, čo nám umožňuje rýchlo definovať a identifikovať zdravotný problém pacienta.</p>
...
export const Patient = props => {
  ...
  return (
      <Fade>
        ...
        <p className="co-container__header co-center">INFORMÁCIE PRE PACIENTOV</p>
